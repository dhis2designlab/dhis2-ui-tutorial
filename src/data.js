...
const data = [
  {
    ...
    short_info:
      "Communicating consistently helps DHIS2 users understand, use and extend DHIS2. In this tutorial you will learn how to communicate effectively in DHIS2 applications",
    id: 0,
    steps: [
      {
        selector: ".first-step",
  ...
  },
  {
    ...
    quizId: Layout,
    short_info:
      "The visual architecture of an application is made up of layout, spacing and stacking. The visual architecture of DHIS2 applications should follow some basic rules to provide a consistent user experience across different types of apps",
    id: 1,
    steps: [
      {
        selector: ".first-step",
        content: (
          <div>
            <h3>Layout, Spacing, Stacking</h3>{" "}
            <p>
              The visual architecture of an application is made up of layout,
              spacing and stacking. The visual architecture of DHIS2
              applications should follow some basic rules to provide a
              consistent user experience across different types of apps. Click
              next to learn how to make layouts in DHIS2!{" "}
            </p>
          </div>
        ),
      },

      {
        selector: ".first-step",
        content: (
          <div className={classes.reactourOpen}>
            <h5>Topic 1: spacing</h5>
            <p>
              Which of these choices for layout do you think is best? Think
              about why when you answer. To answer click on your chosen image
            </p>
            <img src={Fallback} alt="img" width="250px" />
            <br></br>
            <br></br>
            <img src={Fallback} alt="img" width="250px" />
          </div>
  ...
  },
  {
    ...
    quizId: Forms,
    short_info:
      "Forms are one of the most common ways an application collects user input. DHIS2 applications should follow some common form guidelines to make sure users are not unnecessarily challenged when working with forms.",
    id: 2,
    steps: [
      {
        selector: ".first-step",
  ...
  },
  {
    ...
    quizId: Components,
    short_info:
      "A collection of UI elements that should be reused across all DHIS2 applications. Using these components means more time spent focusing on building a positive user experience and less time redesigning and rebuilding common components. In this tutorial you learn how and when to use the different components.",
    id: 6,
    steps: [
      {
        selector: ".first-step",
