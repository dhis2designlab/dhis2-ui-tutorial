...
const UserProvider = ({children}) => {
            ...
            if (user) {
                ...
                userReference.get().then((doc) => {
                    if(doc.exists ){
                        ...
                        let fetchedCourses = []
                        userReference.collection("points").get().then(function(querySnapshot) {
    ...
    return <UserContext.Provider value={{currentUser, setCurrentUser, completedCourses, setCompletedCourses}}>{children}</UserContext.Provider>
}
